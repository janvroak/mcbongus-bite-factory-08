...
const fallbackImages = {
  ...
  // Indian food by type
  indian: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  butterchicken: "https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  // Chinese food
  chinese: "https://images.unsplash.com/photo-1563245372-f21724e3856d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  noodles: "https://images.unsplash.com/photo-1607330289024-1535acc30bd8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  dimsum: "https://images.unsplash.com/photo-1496116218417-1a56e30069a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  springroll: "https://images.unsplash.com/photo-1515669097368-22e68427d265?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  friedrice: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  // Desserts
  ...
  tiramisu: "https://images.unsplash.com/photo-1571877227200-a0d98ea2ac1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  pannacotta: "https://images.unsplash.com/photo-1488477304112-4944851de03d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  cannoli: "https://images.unsplash.com/photo-1611293388250-580b08c4a145?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  gelato: "https://images.unsplash.com/photo-1629213428121-fda95217624d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  // Sides
  ...
  macandcheese: "https://images.unsplash.com/photo-1543339494-b4cd1c1e4e52?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  sweetpotatofries: "https://images.unsplash.com/photo-1604152135912-04a022e23696?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  // Drinks
  ...
  chocolate: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  strawberry: "https://images.unsplash.com/photo-1579954115563-e72bf1381629?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
...
const MenuItem = ({ item, restaurantName, onAddToCart }: MenuItemProps) => {
  ...
  const getFallbackImage = (itemName: string) => {
    ...
    if (lowerName.includes('penne')) return fallbackImages.pasta;
    if (lowerName.includes('ravioli')) return fallbackImages.pasta;
    ...
    if (lowerName.includes('donburi') || lowerName.includes('don')) return fallbackImages.japanese;
    if (lowerName.includes('gyudon')) return fallbackImages.chinese;
    ...
    if (lowerName.includes('guacamole')) return fallbackImages.nachos;
    
    // Indian
    if (lowerName.includes('butter chicken')) return fallbackImages.butterchicken;
    ...
    if (lowerName.includes('dal')) return fallbackImages.curry;
    if (lowerName.includes('chole')) return fallbackImages.curry;
    if (lowerName.includes('palak')) return fallbackImages.curry;
    
    // Chinese
    if (lowerName.includes('spring roll')) return fallbackImages.springroll;
    ...
    if (lowerName.includes('fried rice')) return fallbackImages.friedrice;
    if (lowerName.includes('kung pao')) return fallbackImages.chinese;
    if (lowerName.includes('sweet and sour')) return fallbackImages.chinese;
    if (lowerName.includes('mapo tofu')) return fallbackImages.chinese;
    
    // Desserts
    if (lowerName.includes('tiramisu')) return fallbackImages.tiramisu;
    if (lowerName.includes('panna cotta')) return fallbackImages.pannacotta;
    if (lowerName.includes('cannoli')) return fallbackImages.cannoli;
    if (lowerName.includes('gelato')) return fallbackImages.gelato;
    ...
    // Sides
    if (lowerName.includes('french fries') || lowerName.includes('fries')) return fallbackImages.fries;
    if (lowerName.includes('onion ring')) return fallbackImages.onionrings;
    if (lowerName.includes('mac and cheese')) return fallbackImages.macandcheese;
    if (lowerName.includes('sweet potato')) return fallbackImages.sweetpotatofries;
    
    // Drinks
    if (lowerName.includes('vanilla shake') || lowerName.includes('vanilla milkshake')) return fallbackImages.milkshake;
    if (lowerName.includes('chocolate') || lowerName.includes('chocolate shake')) return fallbackImages.chocolate;
